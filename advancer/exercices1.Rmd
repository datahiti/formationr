...
date: "22/09/2025"
output: pdf_document # ioslides_presentation
---
...
## H2 - group_by
Sélectionner, pour chaque mois de l’année, le vol ayant eu le retard le plus important  
```{r}
flights %>% group_by(month) %>% slice_max(dep_delay)
``` 

## H3 - group_by
Ajouter une nouvelle colonne qui contient le retard moyen pour chaque compagnie aérienne  
```{r}
flights %>%
  group_by(carrier) %>%
